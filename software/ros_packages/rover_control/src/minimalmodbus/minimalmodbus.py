...
class Instrument:
    ...
    def _perform_command(self, functioncode: int, payload_to_slave: str) -> str:
        ...
        # CHANGED EXPECTED RESP "SLAVE ADDR" TO 0. 
        # This is because responses from the slave will have 0 as address, as 
        # per modified protocol.
        self.response_address = DEFAULT_MASTER_ADDRESS
        payload_from_slave = _extract_payload(
            response, self.response_address, self.mode, functioncode
        )
